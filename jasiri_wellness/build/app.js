...
function Navigation() {
  ...
  if (isLoggedIn) {
    return __jacJsx("nav", {
      ...
      "className": "title"
    }, ["Jasiri-Ke Wellness"]), __jacJsx("div", {
...
function FeaturesPage() {
  if (jacIsLoggedIn()) {
    return __jacJsx("div", {
    ...
    }, ["Your Space - Jasiri-Ke Harmony Space ✨"]), __jacJsx("p", {
      "className": "harmony-subtext"
    }, ["Your safe space for mental wellness 💚"]), __jacJsx("ul", {
      ...
      "className": "features-item"
    }, ["🕰️ 24/7 Chat Support"])]), __jacJsx("div", {
      "className": "back-link"
    }, [__jacJsx("a", {
      "href": "/"
    }, ["Back to Home"])])]);
